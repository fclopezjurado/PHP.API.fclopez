 ...
 * runs the application. Note that it does not cover all use-cases and is
 * tuned to the specifics of this skeleton app, so if your needs are
 * different, you'll need to change it.
 */
class RunAppTest extends \PHPUnit_Framework_TestCase
{
    /**
     ...
     */
    public static function runApp($requestMethod, $requestUri, $requestData = null)
    {
        /**
